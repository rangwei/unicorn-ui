sap.ui.define([
	...
	return BaseController.extend("org.demo.unicorn.ui.controller.Master", {
		...
		onInit : function () {
			...
			this._oGroupFunctions = {
				founded_on : function(oContext) {
					var iNumber = oContext.getProperty('founded_on'),
						key, text;
					if (iNumber <= 20) {
						key = "LE20";
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "org.demo.unicorn.ui.view.ViewSettingsDialog",
					controller: this
		...
		onConfirmViewSettingsDialog : function (oEvent) {
			...
			aFilterItems.forEach(function (oItem) {
				switch (oItem.getKey()) {
					case "Filter1" :
						aFilters.push(new Filter("founded_on", FilterOperator.LE, 100));
						break;
					case "Filter2" :
						aFilters.push(new Filter("founded_on", FilterOperator.GT, 100));
						break;
					default :
						break;
				}
